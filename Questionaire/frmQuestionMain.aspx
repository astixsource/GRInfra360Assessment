...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    ...
    <script src="../Scripts/Question_1.js"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="section-title">
        ...
        <h3 class="text-center">360 DEGREE FEEDBACK SURVEY</span></h3>
        <p class="text-center m-0" id="h6">
            Please respond to each statement using scale provided, ranging from "Does not Demonstrate" to “Always Demonstrates".<br />
    ...
    <!--Ques top header-->
    <div id="tblTopHeader" class="ques-header row g-0">
        <!-- Proper Table Header -->
        <div class="col-md-12" id="h7">
            <div class="col-md-10 ques-header-center" style="text-align: center">
        ...
        <div class="col-md-6 ques-header-center" style="text-align: center">
            ...
            <table class="Questable" style="width: 100%; border-collapse: collapse;">
                <thead>
                    <tr>
                        ...
                        <th style="width: 19.28%; text-align: center; padding: 5px;"><span id="Label0">Does not Demonstrate</span></th>
                        <th style="width: 19.28%; text-align: center; padding: 5px;"><span id="Label1">Sometimes Demonstrates</span></th>
                        <th style="width: 19.28%; text-align: center; padding: 5px;"><span id="Label2">Often <br /> Demonstrates</span></th>
                        <th style="width: 19.28%; text-align: center; padding: 5px;"><span id="Label3">Always <br /> Demonstrates</span></th>
                        <th style="width: 19.28%; text-align: center; padding: 5px;"><span id="Label4">Not <br /> Observed</span></th>
                    </tr>
                </thead>
            </table>
        </div>
