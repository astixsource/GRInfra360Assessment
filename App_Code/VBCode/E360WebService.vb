...
Public Class E360WebService
    ...
    'CHANGE
    <System.Web.Services.WebMethod(EnableSession:=True)>
    Public Function fnShowDispPerson_HHH() As String
        ...
        sb = sb.Append("<div class='section-title'><div class='title-line-center'></div><h3 class='text-center'>Survey <span>Landing Page</span></h3></div>")
    ...
    Public Function fnShowDispPerson() As String
        ...
        Try
            ...
            strTable = strTable & "<div class='section-title'><div class='title-line-center'></div><h3 class='text-center'>KINDLY PROVIDE FEEDBACK FOR PARTICIPANTS IN THE FOLLOWING LIST</h3></div>"
            strTable = strTable & "<div class='section-title'><p>You will be required to complete the survey(s) assuming one of the following roles:</p><ul><li>Self</li><li>Senior</li><li>Direct Report</li><li>Peer</li><li>Other</li></ul>To begin, click on the name of the participant you want to rate. Each survey consists of five screens and should take about 10-15 minutes to complete. If you can’t finish a survey in one sitting, you can save your progress and exit.<br></div>"

            strTable = strTable & "<div><p></p></div>"
            strTable &= "<table class='table table-bordered table-sm' id='tblPreNominated'>"
        ...
        Try
            ...
            While (drdr.Read)
                ...
                For i = 1 To 5
                    ...
                    strTable = strTable & " <td class='text-center' style='width:19.28%; text-align:center;  padding:0px;'>"
